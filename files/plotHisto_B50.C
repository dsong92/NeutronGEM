{
  ...
  TFile a("myresult_B50um_D3mm.root");      
  TFile b("myresult_B50um_D10mm.root");
 
  TH1D *hist1 = new TH1D("E_dep B50D3", "E_dep from All particle in DriftGap;MeV;Entries", 50, 0, 2);
  ...
  char const *filename = "Compare_B50um_D3and10mm.png";
  ...
  legend->AddEntry(hist1,"B 50um / Drift 3mm");
