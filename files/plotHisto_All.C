{
  ...
  TFile c("myresult_B500um_D3mm.root");
 
  TH1D *hist1 = new TH1D("E_dep B5D3", "E_dep from All particle in DriftGap;MeV;Entries", 50, 0, 2);
  TH1D *hist2 = new TH1D("E_dep B50D3", "E_dep from All particle in DriftGap;MeV;Entreis", 50, 0, 2);
  TH1D *hist3 = new TH1D("E_dep B500D3", "E_dep from All particle in DriftGap;MeV;Entreis", 50, 0, 2);
  ...
  char const *filename = "Compare_Drift3mm_B5to500.png";
  ...
  legend->AddEntry(hist1,"B 5um   / Drift 3mm");
  legend->AddEntry(hist2,"B 50um  / Drift 3mm");
  legend->AddEntry(hist3,"B 500um / Drift 3mm");
  legend->Draw();
